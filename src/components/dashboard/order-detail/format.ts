...
export function buildAddressLines(detail: OrderDetail): string[] {
  // Pickup: el order no tiene address. El detail-body se ramifica antes de
  // llamar a esta función para mostrar settings.business_address; este
  // fallback cubre el caso defensivo.
