...
export function CartSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="bottom"
        className="theme-heritage h-[80dvh] w-full max-w-none p-0 sm:max-w-none md:inset-y-0 md:right-0 md:left-auto md:h-dvh md:w-[28rem] md:max-w-[28rem] md:border-l"
      >
