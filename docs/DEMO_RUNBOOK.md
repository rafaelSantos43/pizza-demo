...
| (Removido 2026-04-30) Antes había impresión opcional vía PrintNode | El panel del cajero con beep + toast persistente reemplaza al ticket impreso. Sin hardware en el alcance del MVP. | Si un cliente pide impresión, se reabre como feature opcional (~1 día con PrintNode). |
